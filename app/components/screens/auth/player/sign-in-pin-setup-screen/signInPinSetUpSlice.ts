...
export interface playerPinSetUpSliceState {
  pin: string;
...
const initialState: playerPinSetUpSliceState = {
  pin: "",
  status: "idle",
...
export const playerPinSetUpSlice = createAppSlice({
  name: "playerPinSetUp",
  initialState,
  reducers: (create) => ({
...
export const { setPin, resetResponseData, setShouldSubmitPin, submitPinSetupAsync } = playerPinSetUpSlice.actions;
export const { selectPin, selectShouldSubmitPin, selectStatus, selectResponseData } = playerPinSetUpSlice.selectors;
